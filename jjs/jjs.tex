...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, boxrule=0pt, interior hidden, frame hidden, enhanced, breakable, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colback=white, toprule=.15mm, breakable, opacityback=0, left=2mm, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-color-frame]
